...
Если конфликтов при слиянии веток Git не выявил, слияние пройдет в автоматическом режиме, после чего будет создан так называемый "коммит слияния" (коммит у которого два исходный "родителя").

## Конфликты при слиянии

При слиянии веток в Git возможно возникновение конфликта между разными версиями одного файла. Это происходит, когда один и тот же блок текста в разных ветках отредактирован по разному и Git не может сам определить какая версия корректная.
